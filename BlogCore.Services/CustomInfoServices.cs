...
{
    public class CustomInfoServices : BaseServices<CustomInfo>, ICustomInfoServices
    {
        ICustomInfoRespository dal;
        IMapper _mapper;
        public CustomInfoServices(ICustomInfoRespository _dal, IMapper mapper)
        {
            this.dal = _dal;
            base.baseDal = dal;
            _mapper = mapper;
