...
{
    public class ExtraOtherProjectServices : BaseServices<ExtraOtherProject>, IExtraOtherProjectServices
    {
        IExtraOtherProjectRespository dal;
        IMapper _mapper;
        public ExtraOtherProjectServices(IExtraOtherProjectRespository _dal, IMapper mapper)
        {
            this.dal = _dal;
            base.baseDal = dal;
            _mapper = mapper;
