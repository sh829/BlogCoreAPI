...
{
    public class GraduationStatisticsServices: BaseServices<GraduationStatistics>, IGraduationStatisticsServices
    {
        IGraduationStatisticsRespository dal;
        IMapper _mapper;
        public GraduationStatisticsServices(IGraduationStatisticsRespository _dal, IMapper mapper)
        {
            this.dal = _dal;
            base.baseDal = dal;
            _mapper = mapper;
