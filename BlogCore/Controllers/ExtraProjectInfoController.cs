...
namespace BlogCore.Controllers
{
    ...
    /// 派对额外信息
    /// </summary>
    [Route("api/ExtraProjectInfo")]
    public class ExtraProjectInfoController : Controller
    {
        private readonly IExtraProjectInfoServices _partyAdvisoryInfoServices;
        public ExtraProjectInfoController(IExtraProjectInfoServices partyAdvisoryInfoServices)
        {
            _partyAdvisoryInfoServices = partyAdvisoryInfoServices;
        }
        [HttpGet]
        public async Task<ExtraProjectInfo> Get(int id )
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MessageModel<string>> Post(ExtraProjectInfo advisoryInfo)
        {
        ...
        [HttpPut]
        public async Task<MessageModel<string>> Put(ExtraProjectInfo advisoryInfo)
        {
